...
function renderCodexResultPage(success, message, provider = "codex") {
  ...
  const eyebrow = success ? "Swoosh Router" : "Swoosh Router OAuth";
  ...
  return `<!DOCTYPE html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${title} · Swoosh Router</title>
<style>
