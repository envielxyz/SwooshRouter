...
const INTERNAL_CLI_TOKEN_HEADER = "x-swooshrouter-cli-token";
const INTERNAL_CONNECTION_HEADER = "x-swooshrouter-connection-id";
const INTERNAL_CLI_TOKEN_SALT = "swooshrouter-cli-auth";
