...
export async function POST(request) {
  try {
    ...
    const normalizedBody = validation.value; const n = normalizedBody.n; const providers = parseAllowlist((await getSettings()).mediaProviders ?? process.env.SWOOSH_MEDIA_PROVIDERS);
