...
const CLI_TOKEN_HEADER = "x-swooshrouter-cli-token";
...
export function isLocalRequest(request) {
  ...
  if (request.headers.get("x-swooshrouter-via-proxy")) return false;

  const realIp = request.headers.get("x-swooshrouter-real-ip");
  if (realIp) {
