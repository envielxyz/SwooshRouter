...
const GLOBAL_STATE_KEY = "__swooshAccountPoolState";
...
function deriveAutomaticProviderLimit() {
  try {
    const profile = deriveResourceProfile(undefined, process.env.SWOOSH_PERFORMANCE_PROFILE);
    const configuredRouterMax = positiveInt(
      process.env.SWOOSH_ROUTER_MAX_CONCURRENT,
  ...
  return {
    ...
    maxConcurrentPerAccount: positiveInt(
      firstDefined(
        ...
        env.SWOOSH_MAX_CONCURRENT_PER_ACCOUNT,
    ...
    maxConcurrentPerProvider: positiveInt(
      firstDefined(
        ...
        env.SWOOSH_MAX_CONCURRENT_PER_PROVIDER,
    ...
    queueWaitTimeoutMs: positiveInt(
      firstDefined(
        ...
        env.SWOOSH_ACCOUNT_QUEUE_TIMEOUT_MS,
    ...
    cacheTtlMs: positiveInt(
      firstDefined(
        ...
        env.SWOOSH_ACCOUNT_POOL_CACHE_TTL_MS,
