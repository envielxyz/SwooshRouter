...
const PROFILE_NAME = "Swoosh";
const PROFILE_NAME_KEY = "swooshrouter.profile.name";
const PROFILE_AVATAR_KEY = "swooshrouter.profile.avatar";

const SIDEBAR_COLLAPSED_KEY = "swooshrouter.sidebar.collapsed.v4";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: `${DASH}/swoosh-chat`, label: "Swoosh Chat", icon: MessagesSquare },
